...
- 🎉 **Wave 1+2+2.5+3+4 全部完整收尾 + PR 14b ✅ + Wave 5 PR 22a 起手**（2026-05-16~18 共 **31 MERGED + 7 OPEN/draft + 2 CLOSED**：21 Wave PRs + 6 follow-up + 3 bonus Stage 0 + 1 外部；Wave 5 PR 22a + 3 post-merge follow-up + 3 adapter wire-up；Wave plan 进度 **21/31 = 68%**）：
  ...
  - 🔧 [PR#4295](https://github.com/QwenLM/qwen-code/pull/4295) **Wave 5 PR 22a** acp-bridge skeleton + zero-coupling lift OPEN (doudouOUC, 2026-05-18 16:27 PR#4282 收尾 0 分钟接力; +1126/-732 17 文件; split 22a/22b; 3 primitive git mv 保 blame; 种 PermissionMediator interface 给 PR 24)
  - 🔧 [PR#4291](https://github.com/QwenLM/qwen-code/pull/4291) Follow-up PR#4255 OAuth fold-in OPEN+CHANGES_REQUESTED (doudouOUC, 5 项 post-merge deepseek-v4-pro /review; 2 Critical: poll() raw err.message + poll timeout)
  - 🔧 [PR#4293](https://github.com/QwenLM/qwen-code/pull/4293) Follow-up E2E baseline lockstep OPEN+CONFLICTING (doudouOUC; **第八次 mirror drift**, main E2E 3 platform 全挂)
  - 🔧 [PR#4297](https://github.com/QwenLM/qwen-code/pull/4297) Follow-up PR#4282 post-merge 4 P2 OPEN (doudouOUC; init 用错 fileName + disabledTools stale snapshot 等; review continuously 工作流)
