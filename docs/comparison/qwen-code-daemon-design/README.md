...
- 🎉 **Wave 1+2 完整 + Wave 2.5/3/4 多线推进**（2026-05-16~17 共 **11 MERGED** + 4 OPEN：Wave 2.5 PR 10/11 + Wave 3 PR 12 + Wave 4 PR 15 在飞；doudouOUC 单人 4 PR 跨 3 Wave；**无 block 点**）：
  ...
  - 🔧 [PR#4240](https://github.com/QwenLM/qwen-code/pull/4240) Wave 2.5 PR 11 session metadata + close/delete lifecycle OPEN+CONFLICTING (doudouOUC, 2026-05-17 10:26, DELETE/PATCH/enriched listing + 2 new events + 2 new capability tags + double-close idempotent)
