...
- 🎉 **Wave 1+2+2.5+3+4 全部完整收尾 + PR 14b ✅ + Wave 5 PR 22a 起手**（2026-05-16~18 共 **31 MERGED + 6 OPEN/draft + 3 CLOSED**：21 Wave PRs + 6 follow-up + 3 bonus Stage 0 + 1 外部；Wave 5 PR 22a + 2 post-merge follow-up + 3 adapter wire-up；Wave plan 进度 **21/31 = 68%**）：
  ...
  - 🔧 [PR#4291](https://github.com/QwenLM/qwen-code/pull/4291) Follow-up PR#4255 OAuth fold-in OPEN+CHANGES_REQUESTED (doudouOUC, **review 期间 ×2.8 涨到 +1165/-31, 16 reviews**; 5 post-merge deepseek-v4-pro /review + PR#4255 fold-in 1 deferred 5 项 一并打)
