...
- 🎉 **Wave 1+2+2.5+3+4 全部完整收尾 + Wave 5 PR 22a 起手**（2026-05-16~18 共 **30 MERGED + 8 OPEN/draft + 2 CLOSED**：21 Wave PRs + 5 follow-up + 3 bonus Stage 0 + 1 外部；Wave 5 PR 22a + 3 post-merge follow-up + PR 14b + 3 adapter wire-up；Wave plan 进度 **21/31 = 68%**）：
