...
- 🎉 **Wave 1+2+2.5+3 完整 + Wave 4 6/7 + 1 在飞**（2026-05-16~18 共 **29 MERGED + 5 OPEN/draft + 2 CLOSED**：20 Wave PRs + 5 follow-up + 3 bonus Stage 0 + 1 外部；Wave 4 仅剩 PR 17 + PR 14b + 3 adapter wire-up；Wave plan 进度 **20/31 = 65%**；**无 block 点**）：
