...
- 🔧 **Wave 1 已启动**（2026-05-16）：[PR#4191](https://github.com/QwenLM/qwen-code/pull/4191) Wave 1 PR 2 `feat(serve): capability registry + protocol versions`（doudouOUC `[codex]`，+170/-39，OPEN）
