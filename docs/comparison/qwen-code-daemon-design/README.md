...
- 🎉 **Wave 1+2+2.5+3 完整 + Wave 4 五合 + adapter 3-stage**（2026-05-16~18 共 **24 MERGED + 8 OPEN/draft**：17 Wave PRs + 4 follow-up + 3 bonus Stage 0；Wave 4 PR 19/21 OPEN + 5 adapter wire-up draft + 1 外部 PR；Wave plan 进度 17/31 ≈ 55%；**无 block 点**）：
