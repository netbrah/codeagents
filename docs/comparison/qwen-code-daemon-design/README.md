...
- 🎉 **Wave 1+2+2.5+3+4 + W5 PR 22a 完整 + PR 14b ✅**（2026-05-16~18 共 **32 MERGED + 5 OPEN/draft + 3 CLOSED**：22 Wave PRs + 6 follow-up + 3 bonus Stage 0 + 1 外部；2 post-merge follow-up + 3 adapter wire-up；Wave plan 进度 **22/31 = 71%**）：
