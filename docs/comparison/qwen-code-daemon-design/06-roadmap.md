...
| **4** Auth-gated mutation/control routes | **mutation gating helper** + memory/agents CRUD + approval/tools/init/MCP-restart + FileSystemService 边界 + safe file read + file write/edit + auth device-flow | PR 15-21 — ✅ PR 15/16/18/19/20/21 MERGED (6/7)；🔧 PR 17 [#4282](https://github.com/QwenLM/qwen-code/pull/4282) OPEN (doudouOUC) — Wave 4 仅剩 PR 17 | 1.5c CRUD + 文件 routes |
