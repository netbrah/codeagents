...
| **4** Auth-gated mutation/control routes | **mutation gating helper** + memory/agents CRUD + approval/tools/init/MCP-restart + FileSystemService 边界 + safe file read + file write/edit + auth device-flow | PR 15-21 — ✅ PR 15/16/18/19 MERGED：[#4236](https://github.com/QwenLM/qwen-code/pull/4236) / [#4249](https://github.com/QwenLM/qwen-code/pull/4249) / [#4250](https://github.com/QwenLM/qwen-code/pull/4250) / [#4269](https://github.com/QwenLM/qwen-code/pull/4269)；🔧 PR 21 [#4255](https://github.com/QwenLM/qwen-code/pull/4255) OPEN；PR 17/20 ⏳ | 1.5c CRUD + 文件 routes |
