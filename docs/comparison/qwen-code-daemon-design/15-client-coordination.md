...
每个 kind 的 token scope 限制（[§19 AuthZ](./19-orchestrator-multi-tenancy.md#二orchestrator-4-件事)）：
...
每次 takeover 写入 [§19 audit log](./19-orchestrator-multi-tenancy.md#二orchestrator-4-件事)：
