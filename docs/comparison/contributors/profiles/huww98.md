...
| 地区 | Beijing, China（北京） |
| 个人主页 / 邮箱 | https://www.huww98.cn · huww98@outlook.com（均为 profile 公开字段） |
...
| 角色推断 | 性能 / 构建 / 内存方向的精准外科手术型贡献者；React(Ink) TUI 健壮性与可观测性细节（推断） |
...
- 个人主页 / 博客：https://www.huww98.cn（公开）；公开邮箱 huww98@outlook.com。
...
- 角色定位"性能 / 构建 / 内存方向的精准外科手术型贡献者"为依据 PR 主题与 diff 体量的推断；其在 qwen-code 的 author_association 为 COLLABORATOR，但主业明显在阿里云云原生存储而非 AI Agent（推断）。
