...
- 背景：经 maintainer 2026-05-31 确认，dreamWB 为 **Qwen Code 内部团队成员**（内部花名“维斌”，阿里生态）；其向 alibaba/react-intl-universal 提交过 PR 亦与此一致。真名仍未公开。
...
- 公司/组织经 maintainer 2026-05-31 确认为 **内部 Qwen 团队**（内部花名“维斌”）；真名、地区仍 **未公开**（profile 对应字段为空）。
