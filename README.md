...
- **月度进展分析**：[OpenCode 2026 年 5 月](./docs/comparison/opencode-2026-05-progress.md) — 1567 commit（~27% 自动化水分）三线并行：Effect-TS 全栈重写 / ACP 完整重写硬切 / Zen 商业化基建；含与 Qwen Code 的 7 维设计对比（1 server 托多 workspace vs 1 daemon = 1 workspace 等）
