...
| 入口 | 说明 |
|------|------|
| **[Deep-Dive 索引（152 篇）](./docs/comparison/deep-dive-index.md)** | 按主题分类的全部深度分析文章 |
...
| **[Qoder CLI 对标改进（12 项）](./docs/comparison/qwen-code-qoder-improvements.md)** | 模型成本档位 + Tracker 任务 DAG + Quest 规格驱动 + Claude 迁移链 + agent/skill 创作 meta-skill |
...
| [Qoder CLI 对标改进（12 项）](./docs/comparison/qwen-code-qoder-improvements.md) | 模型成本档位 + Tracker DAG + Quest 规格驱动 + Claude 迁移链 + meta-skill |
